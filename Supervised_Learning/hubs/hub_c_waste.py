...
def run_waste_type():
    ...
    st.info("🧠 **Algorithm Technique Used:** Decision Tree Classifier")
    st.write(
...
def run_waste_management():
    ...
    MODEL_PATH = "Waste-Management-Strategy-Predictor SVC/waste management_model.pkl"
    FEATURE_NAMES = [
        "waste_type",
    ...
    st.info("🧠 **Algorithm Technique Used:** Support Vector Classification (SVC)")
    st.write(
